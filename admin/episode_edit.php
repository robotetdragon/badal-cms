...
// ═══════════════════════════════════════════════════════════════════════════════
//  admin/episode_edit.php — Edit an existing episode
// ═══════════════════════════════════════════════════════════════════════════════
...
12:00 <?= e(__('ep_chapters_ph_interview')) ?>"><?= e($values['chapters']) ?></textarea>
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1.25rem">
                        ...
                        <?php if (!empty($values['audio'])): ?>
                            <label class="btn-delete-media">
                                <input type="checkbox" name="delete_audio" value="1" hidden
                                       onchange="confirmDelete(this, '<?= __('ep_audio_delete_confirm') ?>')">
                                <?= __('delete') ?>
                            </label>
                        <?php endif; ?>
                    </div>
                ...
                <div class="card" style="padding:1.75rem">
                    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1.25rem">
                        ...
                        <?php if (!empty($values['cover'])): ?>
                            <label class="btn-delete-media">
                                <input type="checkbox" name="delete_cover" value="1" hidden
                                       onchange="confirmDelete(this, '<?= __('ep_cover_delete_confirm') ?>')">
                                <?= __('delete') ?>
                            </label>
                        <?php endif; ?>
                    </div>
            ...
            <div style="display:flex;justify-content:space-between;align-items:center;padding-bottom:2rem">
                <form method="POST" action="/admin/episode_delete.php"
                    ...
                    <button type="submit" class="btn" style="background:rgba(255,90,90,.1);color:#ff5a5a;border:1px solid rgba(255,90,90,.25)">
                        <?= __('delete') ?>
                    </button>
                </form>
