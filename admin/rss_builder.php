...
// 3. URL reachability check (basic)
...
?>
<style>
  .check-row { display:flex; align-items:center; gap:.75rem; padding:.6rem 0; border-bottom:1px solid var(--border); font-size:.84rem; }
  .check-row:last-child { border:none; }
  .check-icon { flex-shrink:0; width:20px; height:20px; border-radius:50%; display:flex; align-items:center; justify-content:center; font-size:.7rem; font-weight:700; }
  ...
  .check-label { flex:1; }
  .check-val  { font-size:.75rem; color:var(--muted); font-weight:600; }
  .check-crit { font-size:.65rem; font-weight:700; letter-spacing:.06em; text-transform:uppercase; color:#ff5a5a; background:rgba(255,90,90,.1); border-radius:20px; padding:.1rem .4rem; flex-shrink:0; }
  ...
  .rss-url-box code { font-size:.82rem; color:var(--accent); font-family:monospace; flex:1; word-break:break-all; }
  .copy-btn { background:var(--surface2); border:1px solid var(--border); border-radius:6px; color:var(--muted); font-family:'Syne',sans-serif; font-size:.73rem; font-weight:600; padding:.28rem .6rem; cursor:pointer; white-space:nowrap; transition:color .15s; }
  .copy-btn:hover { color:var(--accent); }

  .submission-card { background:var(--surface); border:1px solid var(--border); border-radius:12px; padding:1.25rem; display:flex; gap:1.1rem; align-items:flex-start; }
  .submission-card .logo { width:44px; height:44px; border-radius:10px; display:flex; align-items:center; justify-content:center; flex-shrink:0; font-size:1.3rem; }
  .submission-card h3 { font-size:.9rem; font-weight:700; margin-bottom:.2rem; }
  .submission-card p  { font-size:.78rem; color:var(--muted); line-height:1.5; margin-bottom:.6rem; }
  .sub-link { display:inline-flex; align-items:center; gap:.3rem; font-size:.78rem; font-weight:700; color:var(--accent); text-decoration:none; }
