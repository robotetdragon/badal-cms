...
<aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-brand">
        <div class="sidebar-logo"
             style="-webkit-mask: url('<?= url('/audio/badal_logo.svg') ?>') center/contain no-repeat;
                    mask:         url('<?= url('/audio/badal_logo.svg') ?>') center/contain no-repeat;
                    aspect-ratio: 541/183"
             aria-label="Badal"></div>
        <a href="<?= url('/admin/about.php') ?>" class="sidebar-about">
    ...
    <nav>
        ...
        <a href="<?= url('/admin/podcast.php') ?>"
           class="<?= $currentPage === 'podcast' ? 'active' : '' ?>">
            <i data-feather="mic"></i>
            Mon podcast
        </a>

        <a href="<?= url('/admin/episodes.php') ?>"
           class="<?= $currentPage === 'episodes' ? 'active' : '' ?>">
            <i data-feather="play"></i>
            <?= __('nav_episodes') ?>
        </a>

        <a href="<?= url('/admin/episode_new.php') ?>"
           class="<?= $currentPage === 'episode_new' ? 'active' : '' ?>"
           style="display:none">
        ...
        <a href="<?= url('/admin/import.php') ?>"
           class="<?= $currentPage === 'import' ? 'active' : '' ?>"
        ...
        <a href="<?= url('/admin/stats.php') ?>"
           class="<?= $currentPage === 'stats' ? 'active' : '' ?>">
            <i data-feather="bar-chart-2"></i>
            <?= __('nav_stats') ?>
        </a>

        <a href="<?= url('/admin/style.php') ?>"
           class="<?= $currentPage === 'appearance' ? 'active' : '' ?>">
            <i data-feather="sliders"></i>
            <?= __('nav_appearance') ?>
        </a>

        <a href="<?= url('/admin/security.php') ?>"
           class="<?= $currentPage === 'security' ? 'active' : '' ?>">
            <i data-feather="shield"></i>
            <?= __('nav_security') ?>
        </a>

        <a href="<?= url('/admin/rss_builder.php') ?>"
           class="<?= $currentPage === 'rss_builder' ? 'active' : '' ?>">
            <i data-feather="rss"></i>
            <?= __('nav_rss') ?>
        </a>

        <a href="<?= url('/admin/push.php') ?>"
           class="<?= $currentPage === 'push' ? 'active' : '' ?>">
            <i data-feather="bell"></i>
            <?= __('nav_push') ?>
        </a>

        <a href="<?= url('/admin/tools.php') ?>"
    ...
    <div class="sidebar-footer">
        ...
        <a href="https://github.com/robotetdragon/badal-cms"
