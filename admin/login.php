...
<head>
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        input:focus { border-color: var(--accent); box-shadow: 0 0 0 3px rgba(232,255,90,.12); }
        ...
        .btn:hover         { background: var(--accent-dim); transform: translateY(-1px); box-shadow: 0 4px 16px rgba(232,255,90,.2); }
        .btn:active        { transform: scale(.97); box-shadow: none; transition-duration: .06s; }
...
<body>
    ...
    <div class="login-wrap">
        ...
        <div class="card">
            ...
            <a href="<?= url('/admin/forgot_password.php') ?>"
               style="display:block;text-align:center;margin-top:1.25rem;font-size:.82rem;color:var(--muted);text-decoration:none;transition:color .15s"
               onmouseover="this.style.color='var(--accent)'"
               onmouseout="this.style.color='var(--muted)'"><?= __('forgot_link') ?></a>
