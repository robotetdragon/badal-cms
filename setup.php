<?php
// =============================================================================
//  setup.php — Installation de Badal
//  Détecte l'URL de base, demande login/mdp + langue, écrit config/config.php
// =============================================================================
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !$alreadyInstalled) {
    ...
    if (empty($errors)) {
        ...
        $cfg  = "<?php\n// Généré par setup.php le " . date('Y-m-d H:i:s') . "\n\nreturn [\n\n";
        ...
        // Écrire lang dans session (sera lu par Lang::init)
        session_start();
        $_SESSION['lang'] = $lang;
...
<?php if ($alreadyInstalled): ?>
  <div class="state-icon warn">
    <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="rgba(255,200,0,.9)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
  </div>
  <div class="state-title"><?= $h($t['already_title']) ?></div>
  <div class="state-desc"><?= $t['already_desc'] ?></div>
