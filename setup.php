<?php
// =============================================================================
//  setup.php -- Badal Installation Wizard
//
//  Detects the base URL, asks for login/password + language,
//  writes config/config.php and generates .htaccess.
// =============================================================================
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        // Protection .htaccess for sensitive directories
        ...
        $telemetryFile = __DIR__ . '/config/telemetry.json';
        if (!file_exists($telemetryFile)) {
            file_put_contents($telemetryFile, json_encode([
                'opt_in'     => true,
                'install_id' => bin2hex(random_bytes(12)),
            ], JSON_PRETTY_PRINT), LOCK_EX);
        }

        // Write config & generate .htaccess
...
<?php if ($success): ?>
  ...
  <!-- =================================================================
       Success -- Animated Logo (progressive drawing)
       ================================================================= -->
  <div style="text-align:center;margin-bottom:1.5rem">
    <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet"
         width="591" height="200" viewBox="0 0 591 200"
      ...
      <g transform="translate(295.5, 100) translate(-270.5, -91.5)">
        <path
          ...
          <animate attributeName="stroke-dashoffset"
                   from="1" to="0" dur="2.5s" fill="freeze"
  ...
  <div class="logo-wrap">
    <div class="logo-dot">
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
           stroke="#0d0d0f" stroke-width="2.5"
           stroke-linecap="round" stroke-linejoin="round">
