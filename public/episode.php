...
if (!$ep || ($ep['status'] ?? 'published') === 'draft') {
    http_response_code(404);
    echo '<h1>' . __('pub_not_found') . '</h1>';
    exit;
}
...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .back-link:hover  { color: var(--text); gap: .6rem; }
        ...
        .ep-play-big:hover  { opacity: .85; transform: translateY(-1px); box-shadow: 0 6px 20px rgba(0,0,0,.2); }
        .ep-play-big:active { transform: scale(.95); box-shadow: none; transition-duration: .06s; }
        ...
        .ep-share-btn:hover  { color: var(--accent); transform: scale(1.1); }
        .ep-share-btn:active { transform: scale(.9); transition-duration: .06s; }
        ...
        /* ── Badge / Title / Description / Meta ───────────────────────── */
        .ep-badge {
            display: inline-flex; align-items: center; gap: .4rem;
            background: rgba(232,255,90,.1); color: var(--accent);
        ...
        .ep-tab:active { background: rgba(255,255,255,.06); }
        ...
        .content-body h1,
        .content-body h2,
        .content-body h3                       { font-weight: 700; letter-spacing: -.02em; margin: 2rem 0 .75rem; }
        ...
        .chapter-link:hover  { background: rgba(232,255,90,.06); padding-left: .75rem; }
        .chapter-link:active { background: rgba(232,255,90,.1); }
        ...
        .pp-btn:hover  { color: var(--text); border-color: var(--muted); transform: scale(1.08); }
        .pp-btn:active { transform: scale(.92); transition-duration: .06s; }

        .pp-btn.play {
            background: var(--accent); border-color: var(--accent);
            color: #0d0d0f; width: 40px; height: 40px;
        }
        .pp-btn.play:hover  { background: #c8df3a; }
        .pp-btn.play:active { background: #b0c02e; }
        ...
        .pp-speed:active { transform: scale(.9); transition-duration: .06s; }
        ...
        .pp-close:active { transform: scale(.85); transition-duration: .06s; }
        ...
        .oe-card:hover  { border-color: var(--accent); transform: translateY(-2px); box-shadow: 0 4px 16px rgba(0,0,0,.15); }
        .oe-card:active { transform: scale(.98); box-shadow: none; transition-duration: .06s; }
        ...
        .oe-dur { font-size: .68rem; color: var(--muted); margin-top: .25rem; }
