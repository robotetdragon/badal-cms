...
// ═══════ AUTOLOADER ═════════════════════════════════════════════════════════════
// Automatically loads core/ classes on demand.
...
// ═══════ CONFIGURATION ══════════════════════════════════════════════════════════
// Associative array returned by config/config.php.
...
// ═══════ BASE PATH ══════════════════════════════════════════════════════════════
// Subdirectory prefix extracted from base_url.
...
// Sent AFTER session initialisation.
// ════════════════════════════════════════════════════════════════════════════════
 ...
 * @return string        The absolute URL with BASE prepended.
 */
 ...
 *
 * @return string  The hexadecimal CSRF token.
 */
